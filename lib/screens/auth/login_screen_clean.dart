...
class _LoginScreenState extends ConsumerState<LoginScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              '🔔 Cross-platform FCM test notification sent! Check notification center.',
            ),
  ...
  /// Test Cross-Platform FCM with detailed info
  void _testCrossPlatformFCM() async {
    try {
      debugPrint(
        '[FCM Test] Testing cross-platform FCM notification system...',
      );
      ...
      final token = await FCMService.getToken();
      debugPrint('[FCM Test] FCM Token: $token');
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: OutlinedButton.icon(
                              onPressed: _testCrossPlatformFCM,
